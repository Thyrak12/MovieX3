...
const CustomMovies = () => {
  const movieNames = ['Black Bird', 'Loki', 'Sonic Prime', 'Lucifer', 'Stranger Things', 'Squid Game', 'Arrow', 'Avenger', 'Spider-Man']; // Custom movie names
  ...
  return (
    <div className='slide-container bg-dark'>
      <button className='button-movie'>Action Movies ➩</button>
      <div className='card-container'>
        <Swiper
